...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        //保存されたスポット名
        String SpotText = i.getStringExtra("SpotText");
        String SpotLatitude = i.getStringExtra("SpotLatitude");
        String SpotLongitude = i.getStringExtra("SpoLongitude");
        TextView textView_set = findViewById(R.id.spotname);
        textView_set.setText(SpotText);
...
//                LocationRequest.PRIORITY_NO_POWER);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (genre.equals("飲食店")) {
                    genreNumber = 1;
                } else if (genre.equals("ショッピングモール")) {
                    genreNumber = 2;
                } else if (genre.equals("レジャー施設")) {
                    genreNumber = 3;
                } else if (genre.equals("観光スポット")) {
                    genreNumber = 4;
                } else if(genre.equals("アミューズメント施設")){
                    genreNumber = 5;
